    ...
    <header className="w-full">
      <div className="bg-[#1d1d1d] text-white text-sm flex justify-between items-center px-6 py-2">
        <div className="flex items-center gap-4">
          ...
          <Link to={''}>
            <span className="flex items-center hover:text-teal-400 gap-2">
              <FontAwesomeIcon icon={faPhone} className="text-teal-400 " /> 1 562 867 5309
            </span>
          </Link>

          <Link to={''}>
            <span className="hidden md:flex items-center hover:text-teal-400 gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center bg-[#4ed4d2] px-3 py-1 rounded-sm font-medium gap-2"
          >
      ...
      <nav className="bg-white flex justify-between items-center px-8 shadow-sm">
        <Link to={'/'}>
          <img
            width={"100px"}
            height={"80px"}
            src="https://i.ibb.co/fYt9mDrs/Chat-GPT-Image-Oct-27-2025-10-48-49-PM-removebg-preview.png"
            alt=""
          />
        </Link>
